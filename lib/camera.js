...
import {drawBoundingBox, drawKeypoints, drawSkeleton, isMobile, toggleLoadingUI, tryResNetButtonName, tryResNetButtonText, updateTryResNetButtonDatGuiCss} from './demoUtil';
                ...
                keypoints.forEach(
                    ( keypoint ) => {
                        ...
                        switch ( keypoint.part ) {
                            ...
                            case 'rightElbow':
                            case 'rightShoulder':
                                gamePoses[ keypoint.part ] = keypoint;
                                break;
                        }
                    }
                );
